...
define( 'BEBCVBANNER_VERSION', '1.2.0' );

define( 'BEBCVBANNER_VERSION_CSS_ADM', '1.1.0' );
define( 'BEBCVBANNER_VERSION_CSS_ADM_ADD', '1.0.1' );
define( 'BEBCVBANNER_VERSION_CSS_ADM_PREV', '1.0.1' );
...
define( 'BEBCVBANNER_VERSION_JS_ADM_ADD', '1.1.0' );
define( 'BEBCVBANNER_VERSION_JS_ADM_PREV', '1.0.0' );
define( 'BEBCVBANNER_VERSION_JS_ADM_SET', '1.0.1' );
