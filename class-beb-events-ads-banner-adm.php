...
class Beb_Events_Ads_Banner_Adm extends Beb_Events_Ads_Banner_Op_Com {
	...
	private function carica_menu () {
	    $this->hook_pagine[] = add_menu_page(
	    ...
	    $this->hook_pagine[] = add_submenu_page(
	...
	public function beb_eab_adm_carica_stile_script ($hook) {
	    if (array_search($hook, $this->hook_pagine) === false) {
	        return;
	    }
	    ...
	    <div id="beb-eab-contenitore-admin" class="beb-eab-imp-add">
	       <h1 style="line-height: 26px; margin: 0; text-align: center;">
            ...
            <h4 style="color: #ff0000; text-align: center;">
                *<?php echo __("unfortunately for now you can only create one banner", "beb-cv-banner"); ?>
    	    </h4>
                    ...
                    <tbody>
                        <tr>
                            <td style="padding-bottom: 15px;">
                                <strong><?php echo __("Activate:", "beb-cv-banner"); ?>&nbsp;&nbsp;&nbsp;</strong>
                        	    ...
                        	    &nbsp;&nbsp;&nbsp;
                        	    <span class="beb-eab-add-banner-sugg"><?php echo __("(Show banner)", parent::$prefisso_nome); ?></span>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2">
	...
	public function beb_eab_adm_settings_contenuto () {
        ...
        <div id="beb-eab-contenitore-admin">
            ...
            <ol>
                <li><span class="beb-eab-banner-indice" title="beb-eab-imp-colori"><?php echo __("Banner colors", "beb-cv-banner"); ?></span></li>
        ...
        <form method="post" action="options.php" id="beb-eab-banner-impostazioni">
            ...
            <div id="beb-eab-contenitore-admin" class="beb-eab-imp-colori">
                <h1><?php echo __("Banner colors", "beb-cv-banner"); ?></h1>
                ...
                <table class="form-table">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <th scope="row">
                                <?php echo __("Left link:", "beb-cv-banner"); ?>
                            </th>
                            <td>
                            ...
                            <th scope="row">
                                <?php echo __("Right link:", "beb-cv-banner"); ?>
                            </th>
                            <td>
            ...
            <div id="beb-eab-contenitore-admin" class="beb-eab-imp-formattazione">
                ...
                <table class="form-table" style="margin-top: 20px;">
                    <tbody>
                        <tr>
                            <th scope="row">
                                <?php echo __("Event Date - Day: ", "beb-cv-banner"); ?>
                            </th>
                            <td>
                        ...
                        <tr>
                            <th scope="row">
                                <?php echo __("Event Date - Month: ", "beb-cv-banner"); ?>
                            </th>
                            <td>
