...
class Beb_Events_Ads_Banner_Adm extends Beb_Events_Ads_Banner_Op_Com {
	...
	public function beb_eab_adm_carica_stile_script ($hook) {
	    ...
	    if ($hook === $this->hook_pag_add) {
	        ...
	        wp_enqueue_style (parent::$prefisso_nome.'-adm-add.css', false, array(), BEBCVBANNER_VERSION_CSS_ADM);
	        wp_enqueue_script(parent::$prefisso_nome.'-adm-add.js', false, array(), BEBCVBANNER_VERSION_JS_ADM);
	    } elseif ($hook === $this->hook_pag_preview) {
	        $custom_css .= 'top: 40px;';
	        wp_enqueue_style (parent::$prefisso_nome.'-adm-prev.css', false, array(), BEBCVBANNER_VERSION_CSS_ADM);
	        wp_enqueue_script(parent::$prefisso_nome.'-adm-prev.js', false, array(), BEBCVBANNER_VERSION_JS_ADM);
	    } elseif ($hook === $this->hook_pag_settings) {
	        $custom_css .= 'top: 40px;';
	        wp_enqueue_style (parent::$prefisso_nome.'-adm-set.css', false, array(), BEBCVBANNER_VERSION_CSS_ADM);
	        wp_enqueue_script(parent::$prefisso_nome.'-adm-set.js', false, array(), BEBCVBANNER_VERSION_JS_ADM);
	    }
	    $custom_css .= ' }';
	    ...
	    <div id="beb-eab-contenitore-admin" class="beb-eab-imp-add" style="margin: 1% 3% 3%;">
	       <h1 style="line-height: 26px; margin: 0; text-align: center; width: 100%;">
            ...
            <h4 style="color: #ff0000; text-align: center; width: 100%;">
                *<?php echo __("unfortunately for now you can only create one banner", parent::$prefisso_nome); ?>
    	    </h4>
	       ...
	       <form method="post" action="options.php">
               ...
               <fieldset class="contenitore-input beb-eab-add-options-el" style="float: none; padding: 0 3% 3%;">
                    ...
                    <div class="beb-eab-stato-banner-riassunto" style="background: url('<?php echo BEBCVBANNER__PLUGIN_URL.'img/off.png'; ?>') no-repeat scroll 0 0 rgba(0, 0, 0, 0);">
                        <input type="hidden" value="off" name="<?php echo $nome_arr_form; ?>[stato_banner]" />
                        &nbsp;
                    </div>
               ...
               <fieldset class="contenitore-input beb-eab-add-texts-el" style="">
                    ...
                    <input type="text" id="beb-eab-titolo" name="<?php echo $nome_arr_form; ?>[titolo]" <?php
                        if (isset($this->banner_da_modificare['titolo'])) {
                	       ...
                	       echo 'placeholder="'.__("Insert Title here", parent::$prefisso_nome).'"';
                        }?> />
                    <p class="beb-eab-add-banner-sugg">
                ...
                <fieldset class="contenitore-input beb-eab-add-links-el" style="">
                    ...
                    <input type="text" id="beb-eab-link-sx-titolo" name="<?php echo $nome_arr_form; ?>[link_sx_titolo]" <?php
                        if (isset($this->banner_da_modificare['link_sx_titolo'])) {
                            ...
                            echo 'placeholder="'.__("Insert left title link here", parent::$prefisso_nome).'"';
                        }?> />
            	    <p class="beb-eab-add-banner-sugg">
            	    ...
            	    <p class="beb-eab-add-banner-link">
                        ...
                        <input type="text" id="beb-eab-link-sx" name="<?php echo $nome_arr_form; ?>[link_sx]" <?php
                            if (isset($this->banner_da_modificare['link_sx'])) {
                                ...
                                echo 'placeholder="'.__("http://www.yourlink.link", parent::$prefisso_nome).'"';
                            } ?> />
                    </p>
            	    <p class="beb-eab-add-banner-link-sugg beb-eab-add-banner-sugg">
                    ...
                    if (isset($this->banner_da_modificare['link_dx_titolo'])) {
                        ...
                        echo 'placeholder="'.__("Insert right title link here", parent::$prefisso_nome).'"';
                    } ?> />
            	    <p class="beb-eab-add-banner-sugg">
                ...
                <fieldset class="contenitore-input beb-eab-add-media-el" style="">
                    ...
                    <input type="text" id="beb-eab-immagine" name="<?php echo $nome_arr_form; ?>[immagine]" <?php
                        if (isset($this->banner_da_modificare['immagine'])) {
                	        echo 'value="'.esc_attr( $this->banner_da_modificare['immagine']).'"';
                	    } else {
                	       echo 'placeholder="'.__("Insert Image link here", parent::$prefisso_nome).'"';
                        }?> />     
            	    ...
            	    <p class="beb-eab-add-banner-media">
                        ...
                        <?php if (isset($this->banner_da_modificare['immagine_show']) and 'show' === $this->banner_da_modificare['immagine_show']) {
                            echo 'checked="checked"';
                        } ?> style="margin-left: 25%;">
                        <?php echo __("Show", parent::$prefisso_nome); ?>&nbsp;&nbsp;&nbsp;
                	    <input type="radio" name="<?php echo $nome_arr_form; ?>[immagine_show]" value="hide" 
                	    <?php if (isset($this->banner_da_modificare['immagine_show'])) {
                	        if ('hide' === $this->banner_da_modificare['immagine_show']) {
                	            echo 'checked="checked"';
                	        }
                        } else {
                            echo 'checked="checked"';
