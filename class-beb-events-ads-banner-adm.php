...
class Beb_Events_Ads_Banner_Adm extends Beb_Events_Ads_Banner_Op_Com {
	...
	public function beb_eab_adm_problemi_contenuto () {
       ...
       <div id="beb-eab-contenitore-admin" class="beb-eab-event-calendar">
           	<h1 style="color: #0000ff; text-align: center;"><?php
				...
				<tbody>
	                ...
	                <tr style="margin-top: 10px; vertical-align: top;">
	                  	<th>
	                   	...
	                   	<td>
	                   		<?php echo __('I looked for the source of this incompatibility and I came to the following conclusion:',
	                   				parent::$prefisso_nome); ?>
	               ...
	               <tr>
						<td colspan="2">
							<p class="submit">
		                    	<input id="submit" type="submit" class="button button-primary" value="<?php echo __("Save", parent::$prefisso_nome); ?>"
		                    	name="<?php echo $nome_arr_form; ?>[submit]" style="margin-left: 47%;" />
		                    </p>
						</td>
	               </tr>
				</tbody>
