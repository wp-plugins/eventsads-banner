jQuery(document).ready(function($){
	...
	$('#beb-eab-contenitore-admin form select').each(function(element) {
		...
		if ($('#beb-eab-banner-data h1').text() == '') {
			...
			if (larghezza_banner == '385' || larghezza_banner == '485') {
				$('.beb-eab-spazio-banner').css('width', parseInt(larghezza_banner) - 62 + 'px');
				$('.beb-eab-contenuto-banner').css('width', parseInt(larghezza_cont_banner) - 62 + 'px');
			}
		} else {
		...
		$(this).change(function() {
			...
			if (larghezza_banner == '323' || larghezza_banner == '423') {
				$('#beb-eab-banner-data').css('display', 'inline');
				$('.beb-eab-spazio-banner').animate({'width': parseInt(larghezza_banner) + 62 + 'px'}, 1000);
				$('.beb-eab-contenuto-banner').animate({'width': parseInt(larghezza_cont_banner) + 62 + 'px'}, 1000);
			}
		});
	});
	/* ------------------------- DESCRIZIONE --------------------- */
